                ...
                <section className="section dashboard">
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="card"><div className="card-body" style={{height: "1200px"}}><h5 className="card-title">Kaydırmayı Test Et</h5><p>Bu alan, sidebar ve header sabitken ana içeriğin kaydığını göstermek için uzatılmıştır.</p></div></div>
                        </div>
                    </div>
                </section>
            </main>
