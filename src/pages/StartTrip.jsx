...
import { getVehicle } from '../store/TripSlice'
...
function StartTrip() {
    ...
    const { selectedVehicle } = useSelector(store => store.trip)
                                        ...
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <form onSubmit={handleSubmit}>
                                                    ...
                                                    {/* 1. Gidilecek Yer */}
                                                    <div className="mb-3">
                                                        <label htmlFor="destinationInput" className="form-label">Gidilecek Yer</label>
                                                        <input
                                                            type="text"
