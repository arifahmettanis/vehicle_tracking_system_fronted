...
function StartTripComponent({ id }) {
  const { selectedVehicle, error, loading } = useSelector((store) => store.vehicle);
  const initialState = useSelector((store) => store.vehicle);
  ...
  const handleSubmit = async (event) => {
    ...
    const tripData = {
      ...
      reason: tripReason,
      description,
      return_estimate: estimatedReturnTime,
    };
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    {/* Gidilecek Yer */}
                    <div className="mb-3">
                      <label htmlFor="whereInput" className="form-label">
                        Gidilecek Yer
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="mb-3">
                      <label htmlFor="returnTimeInput" className="form-label">
