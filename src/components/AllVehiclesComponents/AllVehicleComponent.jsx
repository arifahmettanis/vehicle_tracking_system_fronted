...
function AllVehiclesComponent() {
    ...
    if (loading) {
        return <div className="spinner-border" role="status"><span className="visually-hidden">Yükleniyor...</span></div>;
    }
                            ...
                            <tbody>
                                {allVehicles.map(vehicle => (
                                    <tr key={vehicle.id}>
                                        ...
                                        <td>{vehicle.brand} {vehicle.model} ({vehicle.model_year})</td>
